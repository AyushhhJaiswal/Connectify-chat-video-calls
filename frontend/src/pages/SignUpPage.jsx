        ...
        rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 p-4 sm:p-8 flex flex-col">
                        ...
                        <div className='mb-4 flex items-center justify-start gap-2'>
                            <Orbit className="size-9 text-primary "/>
                            ...
                            <form onSubmit={handleSignup}>
                                <div className='space-y-4'>
                                    ...
                                    <div className='form-control w-full'>
                                        ...
                                        className='input input-bordered w-full placeholder:text-gray-400 placeholder:text-opacity-70'
                                    ...
                                    <div className='form-control w-full'>
                                        ...
                                        <p className='text-xs opacity-70 mt-1'>
                                            Password must be atleast 6 charcaters long 
                                        </p>
                                    </div>
          ...
          <div className="max-w-md p-8">
            ...
            <div className="relative aspect-square max-w-sm mx-auto">
              <img src="/Video call.gif" alt="Language connection illustration" className="w-full h-full" />
            </div>
